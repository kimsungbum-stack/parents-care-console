  ...
  return (
    <section className="rounded-xl border border-[#E5E5E5] bg-white p-5">
      <div className="flex flex-col gap-3 border-b border-[#E5E5E5] pb-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          <h2 className="text-[24px] font-bold tracking-tight text-[#0A0A0A]">{lead.guardianName}</h2>
          <p className="mt-1 max-w-2xl text-[15px] leading-[1.6] text-[#737373]">{lead.careSummary}</p>
        </div>
